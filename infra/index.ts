...
const zoneId = aws.route53.getZone({ name: 'beneverly.com' }, { async: true }).then(zone => zone.zoneId);

const certificateValidationDomain = new aws.route53.Record(`beneverly.com-validation`, {
...
const subdomainCertificateValidationDomain = new aws.route53.Record(`beneverly.com-www-validation`, {
